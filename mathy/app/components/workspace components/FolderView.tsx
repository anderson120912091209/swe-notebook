  ...
  return (
    <div className="flex-1 p-8 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        {/* Breadcrumb */}
        <nav className="mb-6 flex items-center gap-2 text-sm" style={{ color: 'var(--foreground-muted)' }}>
          <button
            onClick={handleGoBack}
        ...
        <div className="flex items-start gap-4 mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-[var(--hover-bg)] transition-colors disabled:opacity-50"
            style={{ color: 'var(--foreground)', border: '1px solid var(--border-color)' }}
          >
