...
function MathComponent({
    ...
    const NestedEditor = ({
        ...
        <LexicalNestedComposer initialEditor={initialEditor}>
            <div className={`relative border border-dotted border-gray-300 min-w-[20px] min-h-[20px] flex items-center ${className}`}>
                <RichTextPlugin
                    contentEditable={<ContentEditable className="outline-none min-w-[20px] whitespace-nowrap px-1" />}
    ...
    return (
        <div
            ref={ref}
            className={`inline-flex items-center p-1 rounded font-notomath ${isSelected ? 'ring-2 ring-blue-200 bg-blue-50' : ''
                }`}
        >
            {mathType === 'sum' && (
                <div className="flex flex-col items-center mr-1">
                    <NestedEditor
                        ...
                        nextEditor={operand}
                    />
                    <span className="text-2xl font-serif leading-none">Σ</span>
                    <NestedEditor
            ...
            {mathType === 'int' && (
                <div className="flex items-center mr-1 relative">
                    <span className="text-3xl font-notomath italic mr-1">∫</span>
            ...
            {mathType === 'sqrt' && (
                <div className="flex items-center mx-1">
                    <span className="text-2xl font-notomath mr-0.5">√</span>
